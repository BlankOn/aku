from profile.views import delete_ssh_key, manage_ssh_key, upload_ssh_key
...
from auth.views import (avatarchoose, avatarcrop, avatardelete, delete,
                        ...
                        overview, personal, public, register, searchimages)
...
urlpatterns = patterns(
    ...
    url(r'^profile/edit/location/done/$',
        direct_to_template, {
            'extra_context': {
                'section': 'location'
            },
    ...
    url(r'^email/validation/(?P<key>.{70})/$',
        email_validation_process,
        name='email_validation_process'),
    url(r'^email/validation/reset/$',
