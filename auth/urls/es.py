...
from auth.views import (avatarchoose, avatarcrop, avatardelete, delete,
                        email_validation, email_validation_process,
                        email_validation_reset, fetch_geodata, location,
                        overview, personal, searchimages, register, public)
...
urlpatterns = patterns(
    ...
    url(r'^perfil/editar/ubicacion/listo/$',
        direct_to_template, {
            'extra_context': {
                'section': 'location'
            },
    ...
    url(r'^perfil/editar/personal/listo/$',
        direct_to_template, {
            'extra_context': {
                'section': 'personal'
            },
    ...
    # Avatars
    url(r'^perfil/editar/avatar/eliminar/$',
        avatardelete,
        name='profile_avatar_delete'),
    url(r'^perfil/editar/avatar/$', avatarchoose, name='profile_edit_avatar'),
    url(r'^perfil/editar/avatar/buscar/$',
        searchimages,
        name='profile_avatar_search'),
    url(r'^perfil/editar/avatar/recortar/$',
        avatarcrop,
        name='profile_avatar_crop'),
    url(r'^perfil/edit/avatar/recortar/listo/$',
        direct_to_template, {
            'extra_context': {
                'section': 'avatar'
            },
    ...
    url(r'^registro/validar/$',
        direct_to_template, {'template': 'userprofile/account/validate.html'},
